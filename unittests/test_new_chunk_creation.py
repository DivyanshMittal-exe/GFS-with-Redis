...
class chunk_creation_test(unittest.TestCase):

  def test_chunk_creation(self):
    client = GFSClient()
    with GFS_Server(['123','456','789','321']) as server:
      ...
      chunk_handle_1 = server.file_to_chunk_handles["abc"][0]
      chunk_handle_2 = server.file_to_chunk_handles["abc"][1]
